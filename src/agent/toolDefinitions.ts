...
export const TOOL_DEFINITIONS: Record<string, { description: string; parameters: Record<string, unknown> }> = {
  ...
  gitStatus: {
    ...
    parameters: {
      type: "object",
      properties: {
        cwd: { type: "string", description: "Working directory (workspace-relative path, e.g. 'ai-content-creator')." },
        path: { type: "string", description: "Alias for cwd. Working directory (workspace-relative path)." },
      },
    },
  },
  gitDiff: {
